...
export default function Hero() {
  ...
  return (
    <AuroraBackground
      ...
      // Aurora muncul di kanan atas, konten tetap cream/bersih di kiri
      className="w-full"
    >
      <section
        id="hero"
        ref={sectionRef}
        className="min-h-screen flex items-center justify-between px-[8%] pt-[150px] pb-[100px] relative gap-12 flex-col lg:flex-row w-full"
      ...
      >
        ...
        >
          {/* Blurred background glow on hover */}
          <div
